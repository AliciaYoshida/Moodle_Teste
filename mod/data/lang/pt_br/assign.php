...
/**
 * Strings for component 'assign', language 'pt_br', branch 'MOODLE_35_STABLE'
 *
 * @package   assign
...
$string['calendardue'] = '{$a} está pendente';
$string['calendargradingdue'] = '{$a} está com avaliação pendente';
