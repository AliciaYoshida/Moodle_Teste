...
/**
 * Strings for component 'admin', language 'pt_br', branch 'MOODLE_35_STABLE'
 *
 * @package   admin
...
$string['mobilenotconfiguredwarning'] = 'Moodle móvel não está habilitado.';
...
$string['registermoodlenet'] = '<p>Gostaríamos de manter contato para coisas importantes para seu site Moodle!</p><p>Registrando-se,</p><ul><li>Você está contribuindo  para o nosso conhecimento coletivo sobre os usuários do Moodle o que nos ajuda a melhorar o Moodle e todos os nossos serviços da comunidade.</li><li>Você será um dos primeiros a saber sobre notificações importantes, como alertas de segurança e lançamentos do Moodle.</li><li>Você pode acessar e ativar notificações móveis do seu site Moodle através do nosso<a href="https://download.moodle.org/mobile/"> aplicativo Móvel Moodle gratuíto</a>.</li><li>Opcionalmente, seu site pode ser incluído como um membro orgulhoso e apoiante da comunidade Moodle na <a href="https://moodle.net/stats">lista de sites registrados</a>.</li></ul>';
...
$string['searchallavailablecourses_desc'] = 'Em algumas situações o motor de busca pode não funcionar ao pesquisar em uma grande quantidade de cursos. Defina para pesquisar apenas em cursos com inscrição se você precisar restringir o número de cursos pesquisados.';
