...
/**
 * Strings for component 'cohort', language 'pt_br', branch 'MOODLE_35_STABLE'
 *
 * @package   cohort
...
$string['newidnumberfor'] = 'Novo número ID para coorte {$a}';
$string['newnamefor'] = 'Novo nome para coorte {$a}';
