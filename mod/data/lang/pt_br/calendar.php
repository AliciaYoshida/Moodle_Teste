...
/**
 * Strings for component 'calendar', language 'pt_br', branch 'MOODLE_35_STABLE'
 *
 * @package   calendar
...
$string['confirmeventseriesdelete'] = 'O evento "{$a->name}" é parte de uma série. Você quer deletar apenas este evento ou todos os {$a->count} eventos da série?';
$string['course'] = 'Curso';
...
$string['eventendtimewrapped'] = '{$a} (Final)';
...
$string['hideeventtype'] = 'Esconder {$a} eventos';
...
$string['invalideventtype'] = 'Este tipo de evento que você selecionou é inválido.';
