...
/**
 * Strings for component 'block_quickmail', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
...
$string['addionalemail'] = 'Permitir e-mails para endereços de e-mail externos';
...
$string['allowstudentsdesc'] = 'Permitir que os alunos usem o correio eletrônico. Se você escolher "NUNCA", o bloco não pode ser configurado para permitir que os alunos tenham acesso ao nível do curso.';
...
$string['download_auth_only'] = 'Somente usuários autorizados';
$string['download_open'] = 'Abrir Downloads';
